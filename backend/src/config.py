...
class _Config:
    ...
    CURVEGRID_ENS_REGISTRAR_CONTRACT_LABEL: str
    CURVEGRID_ENS_REGISTRAR_CONTRACT_ADDRESS_ALIAS: str
    ...
    def __init__(self):
        ...
        self.CURVEGRID_ENS_REGISTRAR_CONTRACT_LABEL = os.getenv(
            "CURVEGRID_ENS_REGISTRAR_CONTRACT_LABEL"
        )
        self.CURVEGRID_ENS_REGISTRAR_CONTRACT_ADDRESS_ALIAS = os.getenv(
            "CURVEGRID_ENS_REGISTRAR_CONTRACT_ADDRESS_ALIAS"
        )
