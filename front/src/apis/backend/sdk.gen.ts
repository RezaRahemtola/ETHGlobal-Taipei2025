 ...
 * Get all transactions for the connected user
 */
export const getUserTransactionsUserTransactionsGet = <ThrowOnError extends boolean = false>(options?: Options<GetUserTransactionsUserTransactionsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserTransactionsUserTransactionsGetResponse, GetUserTransactionsUserTransactionsGetError, ThrowOnError>({
 ...
 */
export const searchUsersUserSearchGet = <ThrowOnError extends boolean = false>(options: Options<SearchUsersUserSearchGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchUsersUserSearchGetResponse, SearchUsersUserSearchGetError, ThrowOnError>({
        url: '/user/search',
        ...options
    });
};
 ...
 */
export const thirdwebWebhookThirdwebWebhookPost = <ThrowOnError extends boolean = false>(options: Options<ThirdwebWebhookThirdwebWebhookPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, ThirdwebWebhookThirdwebWebhookPostError, ThrowOnError>({
