  ...
  return (
    <div className="flex items-center justify-between p-5 hover:bg-slate-50 transition-colors">
      <div className="flex items-center space-x-4">
        <div className={`${typeConfig.bgColor} rounded-full p-3`}>
          {typeConfig.icon}
        </div>
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className={`text-xs px-2 py-0.5 rounded-full ${statusConfig.bgColor} ${statusConfig.textColor} font-medium inline-flex items-center gap-1`}>
              {statusConfig.icon}
