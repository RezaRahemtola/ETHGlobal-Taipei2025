...
import { ArrowRightIcon, SendIcon, UserIcon, BanknoteIcon } from "lucide-react";
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      const newTransaction: Transaction = {
        ...
        amount: numAmount,
        recipient,
        recipientAddress: '0x' + Array(40).fill(0).map(() => 
        ...
        <div className="pt-2">
          <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
            <p className="text-sm text-indigo-700">
              <span className="font-semibold">Tip:</span> Send money instantly with zero fees. Your recipient will get the funds in seconds!
            </p>
          </div>
        </div>
      </CardContent>
